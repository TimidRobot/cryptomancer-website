...
Website source for [Cryptomancer™ RPG][website]: a tabletop role-playing game
made for hackers, by hackers

[website]: https://timidrobot.github.io/cryptomancer-website/
...
The development Bash scripts (in `dev/`) are dedicated, with all copyright and
related and neighboring rights, to the public domain worldwide. They are
distributed without any warranty. ([CC0 1.0 Universal (CC0 1.0) Public Domain
Dedication][cc-zero])

[cc-zero-png]: https://licensebuttons.net/p/zero/1.0/88x31.png "CC0 1.0 license button"
